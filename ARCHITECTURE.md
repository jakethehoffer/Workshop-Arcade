...
|--------|----------|--------------|-----------|
| [`scripts/site-config.mjs`](scripts/site-config.mjs) | Canonical `SITE_URL` / path helpers consumed by SEO/social generators | env-driven helper | covered through generator validators |
