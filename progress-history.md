# Workshop Arcade progress history

Archived per-pass changelog entries moved out of [progress.md](progress.md) to keep the working changelog lean. These are the older entries (May 2026 and earlier) in their original file order; the live changelog continues in progress.md.
